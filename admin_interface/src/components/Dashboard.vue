                                            ...
                                            <div class="tab-pane fade" id="home" role="tabpanel" aria-labelledby="home-tab">
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <h6 class="m-0"><img class="rounded-circle m-r-10" style="width:40px;" src="datta-able-bootstrap-dashboard-master/template/assets/images/user/avatar-1.jpg" alt="activity-user">Ida Jorgensen</h6>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <h6 class="m-0"><img class="rounded-circle  m-r-10" style="width:40px;" src="datta-able-bootstrap-dashboard-master/template/assets/images/user/avatar-2.jpg" alt="activity-user">Albert Andersen</h6>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <h6 class="m-0"><img class="rounded-circle  m-r-10" style="width:40px;" src="datta-able-bootstrap-dashboard-master/template/assets/images/user/avatar-3.jpg" alt="activity-user">Silje Larsen</h6>
                                                            </td>
                                                            <td>
