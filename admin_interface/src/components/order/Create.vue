                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        <form>
                                            ...
                                            <button class="btn btn-primary" v-on:click="category_store()">Submit</button>
                                        </form>
                                    </div>
                                </div>
        ...
        methods:{
            category_store:function(){
                ...
                if (result.isConfirmed) {
                    ...
                    axios.post('http://localhost:8000/api/v1/category',form_data,{headers:{"Authorization" : "Bearer " + this.get_cookie}}).then(res => {
                        this.category.name = "";
                        this.category.desc = "";
                        Swal.fire(
                        'Added new!',
